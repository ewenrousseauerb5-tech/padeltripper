...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      target="_blank"
      rel="noreferrer"
      className={`fixed right-4 md:right-6 bg-[#25D366] text-white px-4 md:px-5 py-2.5 md:py-3 rounded-full font-semibold shadow-lg shadow-[#25D366]/20 flex items-center gap-1.5 md:gap-2 hover:scale-105 hover:shadow-xl transition-all z-50 text-xs md:text-sm ${
        cookieBannerVisible ? 'bottom-20' : 'bottom-6'
      }`}
    >
