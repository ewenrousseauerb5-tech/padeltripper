      ...
      <section className="py-16 md:py-20 px-6 bg-white border-b border-stone-200/70">
        <div className="max-w-7xl mx-auto">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-stone-600 leading-relaxed mb-4 text-left">
            ...
            <p className="text-stone-500 leading-relaxed mb-7 text-left">
          ...
          <div className="mt-10 grid md:grid-cols-2 gap-4">
            ...
            <div className="rounded-xl border border-stone-200 bg-brand-light p-4 md:col-span-2">
              ...
              <p className="text-sm text-brand-dark leading-relaxed text-left">
