...
import { ArrowRight, Building2, Trophy, WavesLadder } from 'lucide-react';
...
export default function VenuesPage() {
  return (
    <main>
      ...
      <section className="py-20 md:py-24 px-6 bg-brand-dark">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <h2 className="font-serif text-3xl md:text-4xl font-black uppercase text-white mb-4">
          ...
          <div className="pt-10">
            <Link
              href="/events#booking"
              className="inline-flex items-center gap-2 rounded-full bg-brand-red px-8 py-3 text-xs font-semibold uppercase tracking-widest text-white hover:bg-white hover:text-brand-dark transition-colors"
            >
              Book Your Trip
              <ArrowRight size={14} />
            </Link>
