...
export const ALL_EVENTS: PadelEvent[] = [
  ...
  },
  {
    ...
    location: 'Alicante, Spain',
    hotel: '4* Hotel Alicante Golf',
    image: '/images/padel-group-holiday.jpg',
    imagePosition: 'center',
  },
  {
    id: 91,
  ...
  },
  {
    ...
    name: 'Hosted Alicante Padel Experience: Liam and Matt',
    ...
    price: '£645.00',
    originalPrice: '£745.00',
    promoNote: 'Hosted by Liam and Matt',
    filled: 0,
    max: 16,
    location: 'Alicante, Spain',
    hotel: '4* Hotel Alicante Golf',
    image: '/images/liam-and-matt.jpeg',
