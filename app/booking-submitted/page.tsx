...
export default async function BookingSubmittedPage({ searchParams }: BookingSubmittedPageProps) {
  ...
  return (
    <main className="bg-brand-dark text-white px-6 pt-32 pb-20 md:pt-36 md:pb-24 min-h-screen">
      <section className="max-w-4xl mx-auto">
        <div className="rounded-3xl border border-white/15 bg-white/[0.04] p-6 md:p-10 backdrop-blur-sm">
          ...
          <h1 className="font-serif text-3xl md:text-5xl font-black uppercase leading-[0.95] mb-4">
            Thanks For Your
            <span className="block text-brand-red">Quotation Request</span>
          </h1>

          <p className="text-white/75 text-base md:text-lg leading-relaxed max-w-3xl mb-8">
