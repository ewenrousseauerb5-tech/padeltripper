          ...
          <aside className="h-full rounded-3xl border border-white/12 bg-white/[0.03] p-5 md:p-6 backdrop-blur-sm">
            ...
            <div className="space-y-2.5 text-sm">
              <details className="rounded-xl border border-white/10 bg-white/[0.02] p-3 group">
                <summary className="cursor-pointer list-none font-semibold text-white/90">What does the itinerary look like?</summary>
                <p className="mt-2 text-white/60">Day 1: arrival and welcome drinks. Day 2-3: morning coaching + afternoon social padel. Day 4: final session and departures.</p>
              </details>
              <details className="rounded-xl border border-white/10 bg-white/[0.02] p-3 group">
