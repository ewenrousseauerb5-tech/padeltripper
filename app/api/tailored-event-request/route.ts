...
<div style="font-family:Arial,Helvetica,sans-serif;background:#f4f1ec;padding:24px 12px;">
  <div style="max-width:620px;margin:0 auto;background:#ffffff;border:1px solid #ece7df;">
    ...
    <div style="padding:32px 28px 26px;">
      ...
      <p style="margin:18px 0 0;color:#4e535b;font-size:15px;line-height:1.6;">If you have any questions in the meantime, email <strong style="color:#101218;">hello@padeltripper.com</strong> or message us on WhatsApp at <strong style="color:#101218;">+44 7939870682</strong>.</p>
